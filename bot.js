...
if (tarih > 1296000000) kontrol = '<a:tik3:756946140825649214> Bu Kullanıcı **Güvenli**'
  ...
  let kanal1 = client.channels.cache.find(x => x.id === kanal);
    ...
    .setDescription(`
 » • <:kullanc:792682418645630986>  Hoşgeldin ${member}
 
 » • <:Ykseli:792682482646253609>   Seninle birlikte **${member.guild.memberCount}** kişiyiz.
 
 » • [ **${ayarlar.tag}** ] Tagımızı alarak ekibimize katılabilirsin.
 
 » • <:__:792682523712815114>  <@&${ayarlar.yetkiliROL}> rolündekiler seninle ilgilenecektir.
 
 » •   ${kontrol} 
 
 » • <:K_:791431394953789461>  Hesabın Oluşturulma Tarihi: \n • \` ${moment(member.user.createdAt).format("YYYY DD MMMM dddd (hh:mm:ss)")} \`
 
 » • <:ses:792682562194898974>   Bayan iseniz ses teyit odasında kaydınızı yaptırabilirsiniz. 

`)//splashen
    .setImage('https://media.giphy.com/media/HVwEC9Jz2nXzaTkvHA/giphy.gif')
    .setTimestamp()
