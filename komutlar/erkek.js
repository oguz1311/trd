...
.setDescription(`
• <:kullanc:792682418645630986>   ${kullanıcı} <:kullanc:792682418645630986>    adlı kişinin kaydı başarıyla yapıldı.
• <:ye:792682458616692746>   İsim Yaş • **${isim} • ${yaş}**
• <:__:792682523712815114>     Verilen Roller • <@&${ayarlar.erkekROL}> , <@&${ayarlar.erkekICON}>
• <:__:792682523712815114>   Alınan Roller • <@&${ayarlar.kayıtsızROL}>
